...
async def main():
    ...
    if args is None or args.query is None:
        ...
        chat_details = ChatDetails(
            model=input("No model provided. Please provide a model (local / cloud): "),
            prompt=input("No query provided. Please provide a search query: "),
            engine=input("No query provided. Please provide an engine: "),
            role = "user"
        )
        ...
        chat_details = Chat_Details(
            ...
            query=args.query,
            engine=args.engine,
            api_call=poe_api_call # Ensure poe_api_call is defined/imported!
        )
