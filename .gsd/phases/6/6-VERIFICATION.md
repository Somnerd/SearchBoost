...
| System blocks processes originating from PID 0 / Root permissions | ✓ VERIFIED | Hardcoded `USER node` inside API Dockerfile, UI migrated entirely out of nginx root loop onto port 8080 `nginx-unprivileged:stable-alpine` |
